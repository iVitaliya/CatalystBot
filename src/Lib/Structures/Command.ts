import { PermissionResolvable, Message, GuildMember, Guild, TextBasedChannel } from "discord.js";

import { CatalystClient, ICatalystCommand } from "../index";

export class CatalystCommand implements ICatalystCommand {
    ...
    public constructor(client: CatalystClient, data: ICatalystCommand) {
        this.client = client;
    ...
    public async exec(message: Message, args: string[], member: GuildMember, channel: TextBasedChannel, guild: Guild): Promise<Message | void> {
